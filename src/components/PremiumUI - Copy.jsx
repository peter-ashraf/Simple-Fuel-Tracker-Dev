...
export function VehicleArt({ className }) {
  return (
    <div className={cn("vehicle-art", className)} aria-hidden="true">
      <div className="vehicle-art-grid" />
      <div className="vehicle-art-glow" />
      <div className="vehicle-art-car">
